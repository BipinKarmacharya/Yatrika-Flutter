...
class _TourBookHomeState extends State<TourBookHome> {
    ...
    return Scaffold(
      body: RefreshIndicator(
        ...
        child: CustomScrollView(
          slivers: [
            SliverToBoxAdapter(child: TopBar(onProfileTap: widget.onProfileTap)),
  ...
  Widget _buildHorizontalList(List items, {bool isLarge = false}) => Container(
...
// import 'package:tour_guide/features/explore/data/services/destination_service.dart';
// // import 'package:tour_guide/features/explore/presentation/screens/destination_list_screen.dart';
